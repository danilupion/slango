...
```bash
nvm use              # Use Node.js version from .nvmrc (24.13.0)
...
- **Node version**: Requires Node.js ^24.13.0 (enforced in package.json engines)
- **pnpm version**: Requires pnpm ^10.28.2
