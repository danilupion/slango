...
```bash
nvm use              # Use Node.js version from .nvmrc (24.11.1)
...
- **Node version**: Requires Node.js ^24.11.1 (enforced in package.json engines)
- **pnpm version**: Requires pnpm ^10.22.0
